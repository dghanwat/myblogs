...
jQuery(document).ready(function($)
	{
		...
		*/
		...
		$(window).load(function() {
			...
			$('[data-action^="backtop"]').unbind('click')
		...
		*/
		...
		/* Menu Size Button
		   Used: When Resizing Screen
		*/
		$('[data-action^="nav-left-medium"]').unbind('click');
		$('[data-action^="nav-left-medium"]').click(function() {
			navbarResize('left','medium');
			resizeAffixPanel();
		});
		$('[data-action^="nav-left-small"]').unbind('click');
...
//					navToggle(opposite, "hide");
		...
		*/
		...
		$('[data-action^="remove-navbar"]').unbind('click');
...
//				$('[data-action^="remove-navbar"]').addClass('active');
		...
		$('[data-action^="remove-header"]').unbind('click');
...
//				$('[data-action^="remove-header"]').addClass('active');
		...
		$('[data-action^="fullscreen"]').unbind('click');
...
//				$('[data-action^="fullscreen"]').addClass('active');
		...
		$('[data-action^="boxedtofull"]').unbind('click');
		...
		$('[data-action^="submenu"]').unbind('click');
		...
		*/
		$('[data-action^="click-trigger"]').unbind('click');
		$('[data-action^="click-trigger"]').click(function(e) {
			...
			if (! $(this).hasClass('open')){
				...
				$(this).addClass('open');
				console.log($(this).parent().children('[data-action^="click-target"]'))
		...
		$('[data-action^="expand-all"]').unbind('click');
